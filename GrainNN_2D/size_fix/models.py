...
class correct_Cl(nn.Module):
    def __init__(self, hyper, device, trained_N):
        super(correct_Cl, self).__init__()
        self.input_dim = hyper.feature_dim  ## this input channel
        self.hidden_dim = hyper.layer_size ## this output_channel
        self.num_layer = hyper.layers
        self.w = hyper.G_base
        ...
        self.lstm_decoder = trained_N.lstm_decoder
        self.project = trained_N.project_y
        self.project_y = trained_N.project_y
