...
class ConvLSTM_seq(nn.Module):
    ...
    def forward(self, input_seq, input_param, domain_factor):
        ...
        for i in range(self.out_win):
            ...
            darea = (self.project_a(last_time))*active    # [b,1]
            dfrac = self.project(last_time)/domain_factor*active   # project last time output b,hidden_dim, to the desired shape [b,w]   
