...
#========================start plotting area, plot ini_field, alpha_true, and field======
    ...
    #  ax3.set_title('NN', color=bg_color, fontsize=ft)
      ...
      ax4 .axis('off')
      plt.savefig(var + '_grains' + str(G) + '_case' + str(plot_idx)+ '_anis' + str(anis)+'_G'+str("%1.1f"%G0)+'R' +str(Rmax) + '_error'+ str("%d"%int(miss_rate*100)) + '_frame' +str(final) +'.png',dpi=900,facecolor="white", bbox_inches='tight')
      plt.close()
