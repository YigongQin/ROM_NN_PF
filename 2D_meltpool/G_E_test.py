...
out_win = 4
window = out_win
frames = 15*dilation +1
all_frames = 15*dilation +1
train_frames=frames
...
G = 32    # G is the number of grains
G_small = 8
...
data_dir = 'ML_PF32_train0_test1_grains32_frames15_anis0.080_G02.400_Rmax1.520_seed6933304_rank0_grainsize2.500_Mt76500.h5'
valid_dir = data_dir
model_dir = '../GrainNN_2D/fecr_model'
skip_check = False
