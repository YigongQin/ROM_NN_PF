...
def plot_IO(anis,G0,Rmax,G,x,y,aseq,tip_y,alpha_true,frac, plot_idx,ymax,final,pf_angles, area_true, area, left_grains,plot_flag, embeded_angles):
...
#========================start plotting area, plot ini_field, alpha_true, and field======
    ...
    if plot_flag==True:
     ...
     # ax1.set_title(r'$x-y\ t=0$',color=bg_color,fontsize=ft)
      ax2 = fig.add_subplot(142)
      cs2 = ax2.imshow(embeded_angles[ini_field].T,cmap=newcmp,origin='lower',extent= (xmin,xmax, ymin, ytop))
      subplot_rountine(fig, ax2, cs2, 2)
    #  ax2.set_title(r'$x^{\prime}-y^{\prime}\ t=0$', color=bg_color,fontsize=ft)
      
      ax3 = fig.add_subplot(143)
      cs3 = ax3.imshow(embeded_angles[field].T,cmap=newcmp,origin='lower',extent= (xmin,xmax, ymin, ytop))
      subplot_rountine(fig, ax3, cs3, 3)
     # ax3.set_title(r'$x^{\prime}-y^{\prime}\ t=T$', color=bg_color, fontsize=ft)
      
      ax4 = fig.add_subplot(144)
      cs4 = ax4.imshow(pf_angles[field].T,cmap=newcmp,origin='lower',extent= (xmin,xmax, ymin, ytop))
      subplot_rountine(fig, ax4, cs4, 4)
     # ax4.set_title(r'$x-y\ t=T$',color=bg_color,fontsize=ft)
